...
<body class="antialiased">
    <div class="row justify-left ml-3">
        @if (Auth::user()->name == 'admin')
        Anda adalah Admin
        @else
        <div class="row justify-content-left ml-1">
            <h3>Hai {{ Auth::user()->name }}, <br>
                Role anda adalah {{ Auth::user()->role }} </h3>
        </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            ...
            <div class="card bg-dark mt-3" style="color: black; width: 18rem" `>
                <div class="card-header">
                    Jenis Asset yang terdaftar saat ini
                </div>
                <div class="card-body bg-light">
                    <h4>{{$count}} Asset</h4>
        ...
        <div class="col">
            <img src="vendor/adminlte/dist/img/AMSLogo.png" style="width: 50%;" alt="">
        </div>
