                                ...
                                <tbody>
                                    ...
                                    @foreach ($assets as $asset)
                                        <tr>
                                            ...
                                            <td class="product-img"><img class="rounded"
                                                    src="{{ asset($asset->picture) }}" alt="Img placeholder"
                                                    height="50px"></td>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form action="/Input_Asset/store" method="post" style="color: black;"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select
                                                ...
                                                autocomplete="asset_category" autofocus multiple="multiple">
