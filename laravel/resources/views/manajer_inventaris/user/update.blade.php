    ...
    <body>
        <div class="card bg-dark">
            <div class="card-header">
                ...
                <div class="close"><a href="{{ route('user.show') }}">&times; </a></div>

            </div>
            <div class="card-body">
                <form action="{{route('user.update',compact('users'))}}" method="post" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    <div class="row-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{ $users->name }}"
                                placeholder="{{ $users->name }}" name="name" required>
                        </div>
                    </div>
                    <div class="row-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" value="{{ $users->email }}"
                                placeholder="{{ $users->email }}" name="email" required>
                        </div>
                    </div>
                    <div class="row-md-4">
            ...
            <div class="card-footer">
                ...
                <div class="modal-footer justify-content-center">
                    ...
                    <form action="{{route('user.delete',compact('users'))}}" method="post">
                        @csrf
                        @method('delete')
