                    ...
                    <table class="table table-dark table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $Rent->asset_code }}</td>
                                <td class="product-img"><img class="rounded" src="{{ asset($Rent->borrowing_picture) }}" alt="Img placeholder" height="50px"></td>
                                <td>{{ $Rent->borrowing_date }}</td>
                              
                                <td>
                                    <a href="/report/update/{{ $Rent->id }}" class="edit"><i class="material-icons" data-toggle="tooltip" title="Report">&#xE243;</i></a>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/Input_Rent/store" method="post" style="color: black;" enctype="multipart/form-data">
                        @csrf
                        <div class="row ">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Nama Rent</label>
                                    <input type="text" class="form-control" name="name" required>
                                </div>
                                <div class="form-group">
                                    <label for="Rent_category mb-1">Category</label>
                                    <select class="select2-bg form-control select2 @error('Rent_category') is-invalid @enderror" id="Rent_category" name="Rent_category[]" placeholder="Category" value="{{ old('Rent_category') }}" required autocomplete="Rent_category" autofocus multiple="multiple">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="Rent_purchase_price" required>
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="date" class="form-control" name="Rent_purchase_date" required>
                                </div>
                                <div class="form-group">
