    ...
    <div class="card bg-dark">
                    ...
                    <div class="row justify-text-center" style="width: 100%;">
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" readonly name="name" value="{{$borrowings->asset_code }}" placeholder="{{$borrowings->Name }}" required>
                            </div>
                           
                            <div class="form-group">
                                <label>Tanggal Report</label>
                                <input type="date" class="form-control" name="report_date" value="{{$borrowings->asset_purchase_price }}" required>
                            </div>
                        ...
                        <div class="col">
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" name="description" value="{{$borrowings->description}}" style="height: 120px" required>{{$borrowings->description}}</textarea>
                            </div>
                            <!-- <div class="form-group">
        ...
        <div class="card-footer">
            ...
            <div class="modal-footer justify-content-center">
                ...
                <form action="/delete/{{$borrowings->id}}" method="post">
                    @csrf
                    @method('delete')
