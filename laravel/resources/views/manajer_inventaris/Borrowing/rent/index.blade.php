                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <a href="#addEmployeeModal" class="btn btn-success rounded-pill" data-toggle="modal"><i
                                        class="material-icons ">&#xE147;</i> <span>Borrow An Asset</span></a>
                            </div>
                        </div>
                    </div>
                            ...
                            @foreach ($borrow as $borrow)
                                @if ($borrow->status != 1)
                                    <tr>
                                        ...
                                        @else
                                            <td style="color: #2fe647">Sudah Dikembalikan</td>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <form action="{{ route('rent.save') }}" method="post" style="color: black;"
                            ...
                            <div class="row ">
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" placeholder="Tambahkan Keterangan Disini"
