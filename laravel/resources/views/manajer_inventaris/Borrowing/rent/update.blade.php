    ...
    <body>
        <div class="card bg-dark">
            <div class="card-header">
                Detail Peminjaman
                <div class="close"><a href="{{ route('rent.show') }}">&times; </a></div>

            </div>
            <div class="card-body">

                <form action="{{ route('rent.update', compact('borrow')) }}" method="post" enctype="multipart/form-data">
                    @method('patch')
                    @csrf
                    <div class="row">
                        ...
                        <div class="row justify-content-center" style="width: 100%;">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="description" class="form-control" id="ta"
                                        placeholder="{{ $borrow->description }}" value="{{ $borrow->description }}">
                                </div>
                                @if (Auth::user()->role == 'admin')
                                    <div class="form-group">
                                        ...
                                        <select name="status" class="form-control">
                                            ...
                                            <option selected value="{{ $borrow->status }}">
